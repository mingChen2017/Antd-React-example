                ...
                <TweenOne className="point-wrapper" key={i} style={{ left: item.x, top: item.y }}>
                    <TweenOne
                        ...
                        style={{
                            ...
                            height: r,
                            opacity: b,
                            backgroundColor: `rgb(${Math.round(Math.random() * 95 + 160)},0,0)`,
                        }}
                        animation={{
        ...
        return (
            ...
            <div className="logo-gather-demo-wrapper">
                <QueueAnim delay={300} className="queue-simple">
                    <div key="title"><h1  style={{color: '#b2aaad' }}>&nbsp;&nbsp;Ant Design</h1></div>
                    <div key="body"><p style={{color: '#b3b3b3',margin:'30px'}}>一个 UI 设计语言</p></div>
                </QueueAnim>
                    <br></br>
                <canvas id="canvas" />
                <TweenOne
                ...
                <TweenOne
                    ...
                    className={"logo-gather-demo-word"}
                />
            </div>
